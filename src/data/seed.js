...
// Customers List
const customers = [
  { id: 'cust_1', company: 'Western NSW Local Health District', firstName: 'Margaret', lastName: 'Ellison', email: 'facilities@wnswlhd.health.nsw.gov.au', phone: '(02) 6809 8888', address: '42 Bultje Street, Dubbo NSW 2830', status: 'Active', type: 'Commercial', createdAt: relativeDate(-120), updatedAt: relativeDate(-1) },
  { id: 'cust_2', company: 'Optus Network Infrastructure',      firstName: 'Trevor',   lastName: 'Nash',    email: 't.nash@optus.com.au',                 phone: '0418 772 334', address: 'Level 3, 201 Elizabeth Street, Sydney NSW 2000', status: 'Active', type: 'Commercial', createdAt: relativeDate(-120), updatedAt: relativeDate(-1) },
  { id: 'cust_3', company: 'Cobar Mining Pty Ltd',              firstName: 'Phil',     lastName: 'Drummond',email: 'p.drummond@cobarmining.com.au',      phone: '0427 883 221', address: 'Cobar Mine Site, Peak Hill Road, Cobar NSW 2835', status: 'Active', type: 'Commercial', createdAt: relativeDate(-120), updatedAt: relativeDate(-1) },
  { id: 'cust_4', company: 'Dubbo City Council',                firstName: 'Sandra',   lastName: 'Nguyen',  email: 's.nguyen@dubbo.nsw.gov.au',            phone: '(02) 6801 4000', address: 'Civic Administration Building, Dubbo NSW 2830', status: 'Active', type: 'Government', createdAt: relativeDate(-120), updatedAt: relativeDate(-1) },
  { id: 'cust_5', company: 'NBN Co Regional',                   firstName: 'James',    lastName: 'Whitfield',email: 'j.whitfield@nbnco.com.au',          phone: '0401 234 567', address: '100 Miller Street, North Sydney NSW 2060', status: 'Active', type: 'Commercial', createdAt: relativeDate(-120), updatedAt: relativeDate(-1) },
  { id: 'cust_6', company: 'Transgrid',                         firstName: 'Robyn',    lastName: 'Cassidy', email: 'r.cassidy@transgrid.com.au',         phone: '(02) 9620 3100', address: '180 Thomas Street, Sydney NSW 2000', status: 'Active', type: 'Commercial', createdAt: relativeDate(-120), updatedAt: relativeDate(-1) },
  { id: 'cust_7', company: 'Canopus Station',                   firstName: 'Bruce',    lastName: 'Halliday',email: 'bruce@canopusstation.com.au',         phone: '0428 991 003', address: 'Canopus Station, Bourke Road, Bourke NSW 2840', status: 'Active', type: 'Commercial', createdAt: relativeDate(-120), updatedAt: relativeDate(-1) },
  { id: 'cust_8', company: 'Essential Energy',                  firstName: 'Darren',   lastName: 'Stubbs',  email: 'd.stubbs@essentialenergy.com.au',      phone: '(02) 6588 8000', address: '328 Oliver Street, Bathurst NSW 2795', status: 'Active', type: 'Commercial', createdAt: relativeDate(-120), updatedAt: relativeDate(-1) }
];
...
// Leads Seeding
const leads = [
  { id: 'lead_1', title: 'Solar/Battery/Generator Hybrid System Enquiry', customerId: 'cust_7', customerName: 'Canopus Station',                  contactName: 'Bruce Halliday',   status: 'New',          source: 'Email',   value: 45000,  description: 'Provide details for off-grid hybrid farm bank.', priority: 'High',   createdAt: relativeDate(-12), updatedAt: relativeDate(-12) },
  { id: 'lead_2', title: 'Generator Maintenance Contract Tender',          customerId: 'cust_4', customerName: 'Dubbo City Council',                contactName: 'Sandra Nguyen',    status: 'Qualified',    source: 'Website', value: 28000,  description: 'Dubbo regional council annual maintenance contract tender.', priority: 'High', createdAt: relativeDate(-8),  updatedAt: relativeDate(-2) },
  { id: 'lead_3', title: 'Backup Power Assessment',                        customerId: 'cust_1', customerName: 'Western NSW Local Health District', contactName: 'Margaret Ellison', status: 'Proposal',   source: 'Phone',   value: 12000,  description: 'Emergency assessment of clinical battery status.', priority: 'Medium', createdAt: relativeDate(-15), updatedAt: relativeDate(-5) },
  { id: 'lead_4', title: 'Generator Fleet Maintenance',                    customerId: 'cust_8', customerName: 'Essential Energy',                  contactName: 'Darren Stubbs',    status: 'Negotiation',  source: 'Referral',value: 35000,  description: 'Annual service contract for depot generator fleets.', priority: 'High',   createdAt: relativeDate(-22), updatedAt: relativeDate(-2) },
  { id: 'lead_5', title: 'Emergency Power System Upgrade',                 customerId: 'cust_3', customerName: 'Cobar Mining Pty Ltd',              contactName: 'Phil Drummond',    status: 'New',          source: 'Phone',   value: 180000, description: 'Underground mine generator ventilation upgrade proposal.', priority: 'Urgent', createdAt: relativeDate(-1),  updatedAt: relativeDate(-1) },
  { id: 'lead_6', title: 'Regional Tower Maintenance Contract',            customerId: 'cust_2', customerName: 'Optus Network Infrastructure',      contactName: 'Trevor Nash',      status: 'Lost',         source: 'Email',   value: 95000,  description: 'Telecom network maintenance. Competitor undercut on base travel rates.', priority: 'Low', createdAt: relativeDate(-45), updatedAt: relativeDate(-30) }
];
