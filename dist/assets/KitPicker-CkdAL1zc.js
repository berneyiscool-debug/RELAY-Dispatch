import{s as u,a as b,e as i}from"./index-Bd4puJAb.js";function $({onSelect:y,context:x="quote"}){const n=u.getAll("kits").filter(t=>t.active!==!1),f=["All",...new Set(n.map(t=>t.category).filter(Boolean))],o=document.createElement("div");let r="All",s="";function d(){var v;let t=n;if(r!=="All"&&(t=t.filter(e=>e.category===r)),s){const e=s.toLowerCase();t=t.filter(a=>a.name.toLowerCase().includes(e)||(a.description||"").toLowerCase().includes(e))}o.innerHTML=`
